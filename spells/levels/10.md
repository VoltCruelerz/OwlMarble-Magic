...
Any attempts (even _Wish_ and acts of gods) to change history fail if they would prevent an Archived event from occurring.  All creatures who perceive the event cannot have their memories magically altered to forget the event, nor can they forget the event and one minute before and after through any means whatsoever.  Creatures that learn of the event never question its veracity.
...
You attempt to unmake a target creature or object.  The target must succeed on a Wisdom saving throw or have its age reduced by 1d4 years.  The target loses all memory of the lost time.  If a creature is reduced to an age of zero, it vanishes from existence.  If this event is Archived, that being is irrevocably erased from reality and cannot be restored by any means, even _Soul Recall_, _Wish_, or _Divine Intervention_.
...
Upon this sphere finding itself in the direct path of a fully charged _Arcane Annihilation_, it will devours the pillar of energy, negating the spell's normal effects, whereupon the sphere detonates in a tremendous explosion.
