...
- **Casting Time**: 1 Action
- **Range**: Self
- **Components**: V, S, M (a miniature gem-studded adamantine shield worth at least 2000gp)
- **Duration**: 1 hour
- **Classes**: Wizard

Your hit points cannot be reduced until the spell ends. For the duration, you cannot be afflicted with _Exhaustion_, _Paralyzed_, or _Poisoned_, though if you have them before the spell is cast, they remain in effect.

Attempts to use [Dispel Magic](https://github.com/VoltCruelerz/OwlMarble-Magic/blob/master//spells/levels/03.md#dispel-magic) or [Counterspell](https://github.com/VoltCruelerz/OwlMarble-Magic/blob/master//spells/levels/03.md#counterspell) against this spell have disadvantage.
...
- **Casting Time**: 1 Action
- **Range**: 90 feet
- **Components**: V, S, M (a small vial of acid from an ancient black dragon)
- **Duration**: Instantaneous
- **Classes**: Psion, Sorcerer, Wizard

You point your finger at a target within range and release a burst of pure energy that disintegrates the target. The target must make a Dexterity saving throw. On a failed save, it takes 120 points of force damage. On a successful save, it takes half as much damage. The beam created by this spell passes harmlessly through barriers of magical force such as [Wall of Force](https://github.com/VoltCruelerz/OwlMarble-Magic/blob/master//spells/levels/05.md#wall-of-force).

If the target is reduced to 0 hit points by this spell, it is utterly obliterated and reduced to a cloud of dust that blows away on the breeze, leaving no trace of its existence behind.
...
A wave of healing energy washes over a creature you can see within range that brings it to the pinacle of health. The target regains all Hit Points, and for the next 24 hours, it has advantage on all Constitution saving throws and is immune to Exhaustion, Curses, Disease, Charms, Frightens, Paralyzization, and Stuns.

If used on a corpse that has been dead for no more than 1 minute, it is first restored to life before the above effects are applied.

If the creature is Prone when the spell is cast, it can use its reaction to stand up.

**Higher Levels**: At tenth level, this spell can reduce a willing creature's age by 1 year.
...
You attempt to sever a target creature's link between body and soul.  Its current hit points are reduced by 150. If this reduces it to 0, it dies.

**Higher Levels**: At tenth level, this spell removes 200 hit points.
