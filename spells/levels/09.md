...
While charging, this spell cannot be dispelled or neutralized by any means whatsoever.  Even _Wish_, _Disjunction_, and _Divine Intervention_ have no effect on this spell.  If you lose concentration, the star remains, but you lose the capacity to delay its activation further.
...
A _Greater Restoration_, _Heal_, or _Wish_ spell cast on the target can restore the creature’s true identity.
...
- **Casting Time**: 1 Action
- **Range**: 120 feet
- **Components**: V, S, M (a diamond worth at least 4000gp)
- **Duration**: Concentration, up to 1 minute
