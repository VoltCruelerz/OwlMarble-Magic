...
You grant a creature you touch the ability to see inside other creatures.  For the duration, when the target damages another creature, leaving the victim below one quarter of its health, the victim must make Constitution saving throw to resist dropping to 0 hit points and begin dying.  The DC is equal to 10 or half the damage dealt (rounded down), whichever is higher.
