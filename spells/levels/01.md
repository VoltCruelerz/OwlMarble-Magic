...
You conjure two enormous leeches the size of your forearm that attach themselves to creatures of your choice within range.  At the end of a creature's turn, it takes 1d4 necrotic damage for each leech attached to it.  At the start of your following turns while the spell lasts, the spell's damage die increases by one size, to a maximum of a d12.
...
Constructs, undead, plants, and creatures that lack blood are immune to this damage.  The leeches last for the duration of the spell and are immune to damage, but a creature can use its action to remove all leeches from itself or an ally within five feet of it.  Once removed, leeches fall to the ground, wither, and die.

**Higher Levels**: For each spell level above 1st that this spell is cast at, two additional leeches are conjured.
