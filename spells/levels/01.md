...
You conjure an enormous leech the size of your forearm that attaches itself to a creature of your choice that you can see within range.  At the end of a creature's turn, it takes 1d4 necrotic damage for each leech attached to it.  At the start of your following turns while the spell lasts, the spell's damage die increases by one size, to a maximum of a d12.
