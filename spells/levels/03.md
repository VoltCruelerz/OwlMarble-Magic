...
Your weapon flares with blinding light.

- If your attack is melee, it deals an extra 3d8 radiant damage.
- If your attack is ranged, it deals an extra 3d6 radiant damage.
...
**Higher Levels**: When you cast this spell using a spell slot of 4th level or higher, the extra damage dealt by the attack increases by 1 die (1d8 for melee or 1d6 for ranged) for each slot level above 3rd.
